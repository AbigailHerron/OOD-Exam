/*###########################################################################################################################
 ...
 Description: This Console Project is used to create and populate the GameDataDb Database
                   with some initial data.
 Variables: db, g1, g2, g3, g4 <-- All contained in Main() method
 Methods: Main
 ##########################################################################################################################*/
using System;
...
namespace DataManagement
{
    class Program
    {
        ...
        {
            GameData db = new GameData(); // creating database object (db)

            using (db)
            {
                // Code taken from provided Constructor_Code.txt file
                /*PROVIDED CODE---------------------------------------------------*/
                Game g1 = new Game()
                {
                    Name = "It Takes Two",
                ...
                db.Games.Add(g3);
                db.Games.Add(g4);
                Console.WriteLine("Added game objects to Database");
